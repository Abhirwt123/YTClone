    ...
    return (
        <div className={` absolute top-[62px] ${menu ? "w-[82%]" : "w-[98%]"}`}>
            <div className="wrap px-2 py-1 flex gap-3 items-center overflow-x-scroll barStyle bg-white overflow-hidden">
                {[
                    'All', 'Music', 'Albums', 'Cricket', 'Live', 'Comedy', 'Recently Uploaded', 'New to You', "Movies", "Netflix", "Coading", "News", "Javascript", "Bhajan", "Garhwali Song","Tamil Cinema","Lives","Trailers"
                ].map((opt, index) => {
                    return (
